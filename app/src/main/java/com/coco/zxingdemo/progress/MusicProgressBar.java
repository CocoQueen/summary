...
public class MusicProgressBar extends View {
    ...
    ChartUtil.OnProgressChangeListener changeListener;
...
// mTypedArray.recycle();  
// 加载拖动图标  
        mThumb = getResources().getDrawable(R.mipmap.ic_launcher);// 圆点图片  
        int thumbHalfheight = mThumb.getIntrinsicHeight() / 2;
        int thumbHalfWidth = mThumb.getIntrinsicWidth() / 2;
        mThumb.setBounds(-thumbHalfWidth, -thumbHalfheight, thumbHalfWidth, thumbHalfheight);

        mThumbPress = getResources().getDrawable(R.mipmap.ic_launcher);// 圆点图片  
